...
3. [What you should deliver to the statistician](#what-you-should-deliver-to-the-statistician)
...
4. [What you should expect from the analyst](#what-you-should-expect-from-the-analyst)
...
Use this checklist before handing off data to a statistician:

**Raw Data**
- [ ] Includes the rawest form of the data available
- [ ] No software has been run on the data
- [ ] No data values have been modified
- [ ] No data has been removed from the data set
- [ ] No summarization has been applied

**Tidy Data**
- [ ] Each variable is in one column
- [ ] Each observation is in a different row
- [ ] One table per "kind" of variable
- [ ] Multiple tables include a column to join/merge on
- [ ] Column names are human-readable (e.g., `AgeAtDiagnosis`, not `ADx`)

**Code Book**
- [ ] Describes every variable and its units
- [ ] Documents summary choices made
- [ ] Describes the experimental study design
- [ ] Explains any missing or censored data

**Processing Script**
- [ ] Computer script (R, Python, etc.) takes raw data as input and produces tidy data as output
- [ ] Or pseudocode with exact software versions and parameters is provided
- [ ] Operating system used is documented
- [ ] Results have been confirmed reproducible
